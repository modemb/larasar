          ...
          <q-list bordered class="rounded-borders ellipsis" style="max-width: 1600px">
            <q-item>
              <q-item-section style="max-width: 150px; max-height: 150px;">
                <q-img :src="baseURL+'/'+props.row.post.pics[0].pic" v-if="props.row?.post?.pics[0]"/>
              ...
              <q-item-section>
                ...
                <div class="text-grey-8 q-gutter-xs">
                  ...
                  </template><q-btn size="12px" flat dense :label="$t('delete')" icon="delete" v-else @click="Delete(props.row)" />
...
import { i18n, baseURL, api, timeago, ipDebug, SANCTUM_API } from 'boot/axios'
