          ...
          <q-card class="my-card">
            ...
            <!-- <q-list> -->
              <!-- <q-item @click="viewPost(props.row)">
                <q-img :src="baseURL+'/'+pic" v-if="pic=props.row.pics?.[0]?.pic"/>
                <q-icon name="far fa-image" color="black" size="150px" v-else/>
              </q-item> -->
              ...
              <q-card-section vertical align="right">
                ...
                <div  v-if="(price=props.row.price)>0">
...
export default {
  ...
  setup () {
    ...
    const posts = computed(() => $store.getters['crud/Getter']?.posts)
    ...
    watch([location, distance, checkout, posts], () => gallery())
